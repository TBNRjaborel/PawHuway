        ...
        <SafeAreaView style = {styles.background}>
            ...
            <PagerView style = {{ flex: 1 }}initialPage={0} onPageSelected={(e) => setCurrentPage(e.nativeEvent.position)}>
                <View key = "1" style= {styles.Pages}>
                    ...
                    <View>
                        ...
                        <View style = {styles.imageRow}>
                            <Image source={require("../../assets/pictures/people_with_pets.png")}
                                style={styles.pets}/>
                        </View>
                    </View>
                ...
                <View key = "2" style= {styles.Pages}>
                    ...
                    <View>
                        <View style = {styles.imageRow}>
                            <Image source={require("../../assets/pictures/vet_1.png")}
                                style={styles.pets}/>
                        </View>
                        </View>
                        <View style = {styles.chooseOption}>
                ...
                <View key = "3" style= {styles.Pages}>
                    ...
                    <View>
                        <View style = {styles.imageRow}>
                            <Image source={require("../../assets/pictures/vet_clinic_1.png")}
                                style={styles.pets}/>
                            </View>
                            </View>
                            <View style = {styles.chooseOption}>
